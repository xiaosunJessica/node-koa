...
<template>
   <div
    :class="{
      ...
      [$style['is-left-collapsed']]: state.isLeftCollapse,
      [$style['is-right-collapsed']]: state.isRightCollapse
    }">
    ...
    <div
        ...
        <i class="el-drag-icon el-drag-angle-left" />
    </div>
    <div
